...
namespace RedPen.Net.Core.Parser.Common
{
    public class Line
    {
        /// <summary>value returned for comparison if a character is escaped</summary>
        internal static readonly char EscapedCharacterValue = 'ø';

        /// <summary>a list of offsets for each character</summary>
        internal List<int> offsets = new List<int>();

        /// <summary>the character list for the line</summary>
        internal List<char> characters = new List<char>();

        /// <summary>the text of the line</summary>
        internal string text;

        /// <summary>marks erased characters as invalid</summary>
        internal List<bool> valid = new List<bool>();

        /// <summary>remembers which characters were escaped in the original string</summary>
        internal List<bool> escaped = new List<bool>();

        /// <summary>Whole line is erased.</summary>
        ...
        /// <summary>The erase style.</summary>
        ...
        /// </summary>
        /// <param name="segment">The segment to be erased.</param>
