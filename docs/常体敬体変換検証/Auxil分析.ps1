...
function Auxil分析 {
    # 読み込み
    $dat = Import-Csv .\Auxil.csv -Encoding Default
    ...
    $results | Export-Csv -Encoding Default -NoTypeInformation .\Auxil分析.csv
}

Auxil分析

# 活用型ごとにカウント
Import-Csv .\Auxil.csv -Encoding Default | group 活用型 | foreach {
