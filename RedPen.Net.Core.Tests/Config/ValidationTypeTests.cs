...
namespace RedPen.Net.Core.Tests.Config
{
    ...
    public class ValidationTypeTests
    {
        ...
        {
            ValidationType type = ValidationType.SentenceLength;
            type.GetTypeAsConfigurationClass().Should().Be(typeof(SentenceLengthConfiguration));
            type.GetTypeAsConfigurationClass().FullName.Should().Be("RedPen.Net.Core.Validators.SentenceValidator.SentenceLengthConfiguration");

            type.GetTypeAsValidatorClass().Should().Be(typeof(SentenceLengthValidator));
            type.GetTypeAsValidatorClass().FullName.Should().Be("RedPen.Net.Core.Validators.SentenceValidator.SentenceLengthValidator");
            ...
            Action act = () => nothingType.GetTypeAsConfigurationClass();
            act.Should().Throw<InvalidOperationException>();

            act = () => nothingType.GetTypeAsValidatorClass();
            act.Should().Throw<InvalidOperationException>();
        }
    }
}
